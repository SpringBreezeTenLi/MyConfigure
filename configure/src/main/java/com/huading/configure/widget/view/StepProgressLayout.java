...
public class StepProgressLayout extends ConstraintLayout {
    ...
    private void obtainStyledAttributes(Context context, AttributeSet attrs) {
        ...
        mFirstLineHeight = (int) array.getDimension(R.styleable.StepProgressLayout_step_first_line_height, dip2px(2));
    ...
    //       app:step_first_image="@drawable/error_slices"
    //       app:step_normal_image="@drawable/nothing_slices"
