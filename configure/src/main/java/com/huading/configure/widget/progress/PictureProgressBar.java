package com.huading.configure.widget.progress;
...
public class PictureProgressBar extends View {
    ...
    public PictureProgressBar(Context context, AttributeSet attrs) throws Exception {
        ...
        progress = typedArray.getInt(R.styleable.PictureProgressBar_picprogress, 0);
...
//        getHandler().removeCallbacksAndMessages(null);
    ...
    //        app:backGroundColor="@color/text_FFFFFABA"
    //        app:barColor="@color/text_FD9F30"
    //        android:layout_marginTop="@dimen/dp_16"
    //        android:layout_marginLeft="@dimen/dp_40"
    //        android:layout_marginRight="@dimen/dp_40"
    //        android:background="@color/text_8AD272"
    //        app:drawable="@drawable/chick_main_loading_flower"
    //        app:gradientEndColor="@color/text_8AD272"
    //        app:gradientStartColor="@color/text_FD9F30"
    //        app:halfDrawableHeight="10dp"
    //        app:halfDrawableWidth="10dp"
    //        app:isGradient="false"
    //        app:isRound="true"
    //        app:roundX="25dp"
    //        app:roundY="25dp" />
